...
class ControllerProductProduct extends Controller {
	...
	public function index() {
		...
		if ($product_info) {
			...
			$this->data['polska'] = $this->language->get('polska');
			$this->data['delivery_time_header'] = $this->language->get('delivery_time_header');
			$this->data['delivery_time'] = $this->language->get('delivery_time');
			$this->data['text_model'] = $this->language->get('text_model');
			$this->data['text_reward'] = $this->language->get('text_reward');
			$this->data['text_points'] = $this->language->get('text_points');
			$this->data['text_online_chat'] = $this->language->get('text_online_chat');		
			...
			//$this->data['seen'] = $product_info['reviews'];
			...
			$this->data['rev'] = $product_info['reviews']; 			
