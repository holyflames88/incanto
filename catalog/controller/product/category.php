...
class ControllerProductCategory extends Controller {  
    ...
    $this->data['description'] = "";
			...
			foreach ($results as $result) {
				...
				$this->data['categories'][] = array(
					'name'  => $result['name'] . ($this->config->get('config_product_count') ? ' <span class="product_totals">' . $product_total . '</span>' : ''),
                ...
                foreach($product_options as $option){
                    if($option['option_id']==13){
                        foreach($option['option_value'] as $opt){
                           $option_images[] = $this->model_tool_image->resize($opt['image'], 27, 27);
                        }
                    }
                }
				$this->data['products'][] = array(
