...
class ControllerModuleMegaFilter extends Controller {
	...
	protected function index( $setting ) {
		...
		$this->data['ajaxInfoUrl'] = str_replace( '&amp;', '&', str_replace( $scheme_find, $scheme_replace, $this->data['ajaxInfoUrl'] ) );
		$this->data['ajaxResultsUrl'] = str_replace( '&amp;', '&', str_replace( $scheme_find, $scheme_replace, $this->data['ajaxResultsUrl'] ) );
		$this->data['ajaxCategoryUrl'] = str_replace( '&amp;', '&', str_replace( $scheme_find, $scheme_replace, $this->data['ajaxCategoryUrl'] ) );
