  ...
  <div class="manufacturer-list">
    ...
    <div class="manufacturer-content">
      ...
      <ul>
        ...
        <li><?php if ($category['manufacturer'][$i]['logo']) { ?>
		<div>
		<a href="<?php echo $category['manufacturer'][$i]['href']; ?>"><img src="<?php echo $category['manufacturer'][$i]['logo']; ?>" alt="<?php echo $category['manufacturer'][$i]['name']; ?>" /></a>
		</div>
		<?php } else { ?>
		<div style="padding-bottom: 100px;"></div>
		<?php } ?>
		<a href="<?php echo $category['manufacturer'][$i]['href']; ?>"><?php echo $category['manufacturer'][$i]['name']; ?></a></li>
        <?php } ?>
        <?php } ?>
      </ul>
      <?php } ?>
