  ...
  <div class="row">
    ...
    <div class="col-lg-7 col-md-6">
     <h1><?php echo $heading_title; ?></h1>
	  ...
	  ?>
        <div>
		<?php if($rev) { ?><img src="catalog/view/theme/<?php echo $this->config->get('config_template');?>/image/stars-<?php echo $rating; ?>.png" alt="<?php echo $reviews; ?>" />&nbsp;&nbsp;<a href="<?php echo $adres; ?>#tab-desc"><?php echo $reviews; ?></a>&nbsp;&nbsp;|&nbsp;&nbsp; <?php } ?><a href="<?php echo $adres; ?>#tab-desc"><?php echo $text_write; ?></a></div>
      </div>
      <?php } ?>
...
<div class="category-info product"><?php echo $description; ?>
</div>		
...
<script type="text/javascript" src="catalog/view/javascript/share42/horizontal/product/share42.js"></script>
  ...
  <div id="tab-review" name="tab-review" class="tab-content"><br><br>
  <div class="form-review" style="width:60%">
<br>
<b id="review-title"></b>
...
<!-- //однакові блоки--><div align=center>
<!-- SynonymizeR start -->
