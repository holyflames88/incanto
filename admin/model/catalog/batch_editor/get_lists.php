...
class ModelCatalogBatchEditorGetLists extends Model {
	...
	public function getProductImages($product_id) {
		...
		foreach ($images as $key => $image) {
			if ($image['image']) {
				$images[$key]['thumb'] = $this->model_tool_image->resize($image['image'], 60, 80);
			} else {
				$images[$key]['thumb'] = $this->model_tool_image->resize('no_image.jpg', 60, 80);
			}
		}
	...
	public function getNoImage() {
		...
		return $this->model_tool_image->resize('no_image.jpg', 60, 80);
	}
