...
define("SMSC_LOGIN", $this->config->get('config_login_send_sms_order'));			// логин клиента
define("SMSC_PASSWORD", $this->config->get('config_pass_send_sms_order'));	// пароль или MD5-хеш пароля в нижнем регистре
