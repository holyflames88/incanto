        ...
        <div id="tab-general">
          <table class="form">
            ...
            <tr>
              ...
              <td><input type="text" name="date_end" value="2020-12-31" size="12" id="date-end" /></td>
            </tr>
            <tr>
              <td><?php echo $entry_uses_total; ?></td>
              <td><input type="text" name="uses_total" value="" /></td>
            </tr>
            <tr>
              <td><?php echo $entry_uses_customer; ?></td>
              <td><input type="text" name="uses_customer" value="" /></td>
            </tr>
            <tr>
