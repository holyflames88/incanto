  ...
  <div id="tabs" class="htabs"><a href="#tab-general"><?php echo $tab_general; ?></a><a href="#tab-server"><?php echo $tab_server; ?></a><a href="#tab-front"><?php echo $tab_front; ?></a><a href="#tab-help"><?php echo $tab_help; ?></a></div>
    <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
       ...
       <div id="tab-server">
        <table class="form">
            ...
            <tr>
              ...
              <td> <input type="text" name="pim_uploadMaxSize" value="<?php echo $pim_uploadMaxSize; ?>" size="4" /> <select name="pim_uploadMaxType">
       ...
       <div id="tab-help">
          ...
          <p>
            <b>Power Image Manager</b> is another great module developed by <a href="http://www.opencart.com/index.php?route=extension/extension&filter_username=stone" target="_blank">Sharley's</a>
          </p>
          <h2>Need Support?</h2>
            <a id="activate"  href="mailto: support@sharleys.co.uk?subject=Power Image Manager on <?php echo HTTP_CATALOG;?>" class="green_button">Request support by Email</a>
            <br/>
