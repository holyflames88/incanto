...
class ControllerModulepim extends Controller {
    ...
    $this->data['entry_loadTmbs']        = $this->language->get('entry_loadTmbs');
		...
		if (isset($this->request->post['pim_uploadMaxType'])) {
			$this->data['pim_uploadMaxType'] = $this->request->post['pim_uploadMaxType'];
		} else if($this->config->get('pim_uploadMaxType')){
			$this->data['pim_uploadMaxType'] = $this->config->get('pim_uploadMaxType');
		} else {
  		$this->data['pim_uploadMaxType'] = 'M';
		}		
