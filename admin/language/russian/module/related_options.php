...
$_['text_ro_support']       = "Разработка: <a href='http://feofan.net' target='_blank'>feofan.net</a> | Поддержка, вопросы и предложения: <a href=\"mailto:opencart@19th19th.ru\">opencart@19th19th.ru</a>";
...
$_['entry_spec_price_special']        = 'Акции в связанных опциях';
$_['entry_spec_price_special_help']   = 'указывать разные акции для наборов связанных опций (работает только вместе c включенной функцией "'.$_['entry_spec_price'].'"), если акции для набора связанных опций не заполнены - используются обычные акции товара';
