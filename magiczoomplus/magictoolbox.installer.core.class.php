<?php
    ...
    class MagicToolboxCoreInstallerClass {
        ...
        function sendStat($mode = '') {
            ...
            if('working' == 'v3.1.8' || 'working' == 'v4.5.25') {
                return;
            }
            ...
            $path = "api/stat/?action={$mode}&tool_name=magiczoomplus&license=trial&tool_version=v4.5.25&module_version=v3.1.8&platform_name=opencart&platform_version={$platformVersion}&url={$url}";
